...
const displayText = document.querySelector('.placeholderText');
const showParagraph = document.querySelector('#para');
...
generateBtn.addEventListener('click', () => {
    ...
    if(input.value == '' || userInput < 0 || userInput > 9){  
        showParagraph.innerHTML = `<p>${paragraphs[random]}</p>`;
